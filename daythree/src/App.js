...
const App = () => {
  ...
  const findWinner = () => {
    ...
    else if ((a[0] === "circle" || a[0] === "cross") && (a[2] === "circle" 
        || a[2] === "cross") && (a[3] === "circle" || a[3] === "cross") && 
        (a[4] === "circle" || a[4] === "cross") && (a[5] === "circle" || 
        a[5] === "cross") && (a[6] === "circle" || a[6] === "cross") && 
        (a[7] === "circle" || a[7] === "cross") && (a[8] === "circle" || 
        a[8] === "cross") && (a[1] === "circle" || a[1] === "cross")) {
      ...
      <Container className="p-5">
        <ToastContainer position="bottom-center"></ToastContainer>
         <Row>
           <Col md={6} className="offset-md-3">
           {
               winMessage ? (
                 ...
                 <h1 className="text-center" >{isCross ? "Cross's Turn": "Circle's Turn"}</h1>
         ...
         <h1 className="text-center pt-3">
           Start with <FaTimes onClick={()=>setIsCross(true)} className="icon"/> <FaRegCircle onClick={()=>setIsCross(false)} className="icon"/>
         </h1>
      </Container>
    </>
  );
